<div class="col-sm-3 text-center">
    <div class="folder" id="folder{{$a->id}}">
		...
		<button id="del-album-bt{{$a->id}}" class="btn btn-sm btn-danger pull-right" data-toggle="modal" data-target="#deleteAlbumModal{{$a->id}}"><i class="fa fa-trash" aria-hidden="true"></i></button>
		<button id="edit-album-bt{{$a->id}}" class="btn btn-sm btn-info pull-right"><i class="fa fa-edit" aria-hidden="true"></i></button>
		</div>
		@endif
